...
A python-based motion-capture (Optitrack) paradigm, comparing grip-aperture (of the thumb/finger) scaling when reaching pincer-grip a target object in the presence of a distractor object. The relevant manipulation here is the size (small, med, large) of the target and distractor in a given trial.


Critically, this paradigm consists of two phases:
